...
async function main() {
  ...
  const backerContract = await ethers.getContractAt("Backer", "0xE6498Cd36cD93701237a89f68151582d2cf3EFFB")
  ...
  console.log("AAVE: ", amounts[0].toString())
  ...
  console.log("AAVE: ", backerSwapAmounts[1].toString())
